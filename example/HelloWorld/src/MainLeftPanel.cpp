...
namespace helloworld
{
  ...
  void MainLeftPanelComponent::attachNode(declara::core::scene::NodeComposition &c)
  {
    if (initialized_)
    {
      return;
  ...
  void MainLeftPanelComponent::composeNode(declara::core::scene::NodeComposition &c)
  {
