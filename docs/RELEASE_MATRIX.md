...
| --- | --- | --- | --- | --- |
| `FloppyBird` | n/a — no Linux GUI application target | - [x] ✅ [Windows CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33024992647) (`workflow_dispatch` on `main` = `59e32626`) | - [x] ✅ [macOS CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33027498887) (`workflow_dispatch` on `main` = `59e32626`) | 68K: - [x] ✅ [Assembly-rehearsal manifest](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-manifest.txt) (`retro68-68k-release` at allowlist commit `6e4c7378` = RC + the release-only allowlist files, no code delta; all six release bins + `ASSETS.LRP` collected and hashed; [build log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-build.log.gz))<br>PPC: - [x] ✅ same manifest (`retro68-ppc-release`; five PPC bins collected and hashed; build-verified only) |
| `HelloWorld` | n/a — no Linux GUI application target | - [x] ✅ [Windows CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33024992647) (`workflow_dispatch` on `main` = `59e32626`) | - [x] ✅ [macOS CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33027498887) (`workflow_dispatch` on `main` = `59e32626`) | 68K: - [x] ✅ [Assembly-rehearsal manifest](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-manifest.txt) (`retro68-68k-release` at allowlist commit `6e4c7378` = RC + the release-only allowlist files, no code delta; all six release bins + `ASSETS.LRP` collected and hashed; [build log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-build.log.gz))<br>PPC: - [x] ✅ same manifest (`retro68-ppc-release`; five PPC bins collected and hashed; build-verified only) |
| `MineSweeper` | n/a — no Linux GUI application target | - [x] ✅ [Windows CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33024992647) (`workflow_dispatch` on `main` = `59e32626`) | - [x] ✅ [macOS CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33027498887) (`workflow_dispatch` on `main` = `59e32626`) | 68K: - [x] ✅ [Assembly-rehearsal manifest](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-manifest.txt) (`retro68-68k-release` at allowlist commit `6e4c7378` = RC + the release-only allowlist files, no code delta; all six release bins + `ASSETS.LRP` collected and hashed; [build log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-build.log.gz))<br>PPC: - [x] ✅ same manifest (`retro68-ppc-release`; five PPC bins collected and hashed; build-verified only) |
| `ScrapbookUI` | n/a — no Linux GUI application target | - [x] ✅ [Windows CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33024992647) (`workflow_dispatch` on `main` = `59e32626`) | - [x] ✅ [macOS CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33027498887) (`workflow_dispatch` on `main` = `59e32626`) | 68K: - [x] ✅ [Assembly-rehearsal manifest](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-manifest.txt) (`retro68-68k-release` at allowlist commit `6e4c7378` = RC + the release-only allowlist files, no code delta; all six release bins + `ASSETS.LRP` collected and hashed; [build log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-build.log.gz))<br>PPC: n/a — its CMake target is Retro68/68K-only |
| `SimpleViewer` | n/a — no Linux GUI application target | - [x] ✅ [Windows CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33024992647) (`workflow_dispatch` on `main` = `59e32626`) | - [x] ✅ [macOS CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33027498887) (`workflow_dispatch` on `main` = `59e32626`) | 68K: - [x] ✅ [Assembly-rehearsal manifest](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-manifest.txt) (`retro68-68k-release` at allowlist commit `6e4c7378` = RC + the release-only allowlist files, no code delta; all six release bins + `ASSETS.LRP` collected and hashed; [build log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-build.log.gz))<br>PPC: - [x] ✅ same manifest (`retro68-ppc-release`; five PPC bins collected and hashed; build-verified only) |
| `Tutorial` | n/a — no Linux GUI application target | - [x] ✅ [Windows CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33024992647) (`workflow_dispatch` on `main` = `59e32626`) | - [x] ✅ [macOS CI at the RC](https://github.com/cubenoy22/Loka/actions/runs/33027498887) (`workflow_dispatch` on `main` = `59e32626`) | 68K: - [x] ✅ [Assembly-rehearsal manifest](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-manifest.txt) (`retro68-68k-release` at allowlist commit `6e4c7378` = RC + the release-only allowlist files, no code delta; all six release bins + `ASSETS.LRP` collected and hashed; [build log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/classic-assembly-rehearsal-build.log.gz))<br>PPC: - [x] ✅ same manifest (`retro68-ppc-release`; five PPC bins collected and hashed; build-verified only) |

The Win32 and Linux L0 cells cite `workflow_dispatch` runs on `main` at the RC
itself (the push runs for that commit were lost to a hosted-runner incident);
[Linux CI](https://github.com/cubenoy22/Loka/actions/runs/33024991222) is green at the same RC and backs the host-validation leg.
The macOS cell cites a `workflow_dispatch` run at the RC as well. The Classic cells come from
the clean end-to-end release-assembly rehearsal at `6e4c7378`, which differs
from the RC only by the two release-only allowlist files; there is no code
delta, so those builds are RC-equivalent.
...
| --- | --- | --- | --- | --- |
| `FloppyBird` | n/a — no Linux GUI application target | - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-floppybird-startup-verify.log) (`tests/win32/run-scenario.ps1 floppybird startup`, rig `omen`) | - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh floppybird startup`; audit byte match, 0 differing pixels) | - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh floppybird startup`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `HelloWorld` | n/a — no Linux GUI application target | - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-helloworld-startup-verify.log) (`tests/win32/run-scenario.ps1 helloworld startup`, rig `omen`) | - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh helloworld startup`; audit byte match, 0 differing pixels) | - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh helloworld startup`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `MineSweeper` | n/a — no Linux GUI application target | - [ ] **Blocked by [#496](https://github.com/cubenoy22/Loka/issues/496)** — the Win32 board settles to an incompletely-painted grid on ~1 run in 3 and the two-frame settle rule accepts it, so a golden would encode a coin-flip ([characterization](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-496-repro.txt)); macOS bakes both MineSweeper cells at 0 differing pixels | - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh minesweeper startup`; audit byte match, 0 differing pixels) | - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh minesweeper startup`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `ScrapbookUI` | n/a — no Linux GUI application target | - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-scrapbook-startup-verify.log) (`tests/win32/run-scenario.ps1 scrapbook startup`, rig `omen`) | - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh scrapbook startup`; audit byte match, 0 differing pixels) | - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh scrapbook startup`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `SimpleViewer` | n/a — no Linux GUI application target | - [ ] Runner absent — `SimpleViewer` registers no scenario in `tests/scenarios/scenarios.txt`; the intent-level open-document door it needs is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) | - [ ] Runner absent — `SimpleViewer` registers no scenario in `tests/scenarios/scenarios.txt`; the intent-level open-document door it needs is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) | - [ ] Runner absent — `SimpleViewer` registers no scenario in `tests/scenarios/scenarios.txt`; the intent-level open-document door it needs is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) |
| `Tutorial` | n/a — no Linux GUI application target | - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-tutorial-startup-verify.log) (`tests/win32/run-scenario.ps1 tutorial startup`, rig `omen`) | - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh tutorial startup`; audit byte match, 0 differing pixels) | - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh tutorial startup`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
...
| Example | Linux host | Win32 | macOS | Classic Mac (68K rig) |
| --- | --- | --- | --- | --- |
| `FloppyBird` | n/a — no Linux GUI application target | Scenario: `fixed-step-flaps`; - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-floppybird-fixed-step-flaps-verify.log) (`tests/win32/run-scenario.ps1 floppybird fixed-step-flaps`, rig `omen`) | Scenario: `fixed-step-flaps`; - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh floppybird fixed-step-flaps`; audit byte match, 0 differing pixels) | Scenario: `fixed-step-flaps`; - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh floppybird fixed-step-flaps`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `HelloWorld` | n/a — no Linux GUI application target | Scenario: `bmi-roundtrip`; - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-helloworld-bmi-roundtrip-verify.log) (`tests/win32/run-scenario.ps1 helloworld bmi-roundtrip`, rig `omen`) | Scenario: `bmi-roundtrip`; - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh helloworld bmi-roundtrip`; audit byte match, 0 differing pixels) | Scenario: `bmi-roundtrip`; - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh helloworld bmi-roundtrip`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `MineSweeper` | n/a — no Linux GUI application target | Scenario: `new-game-twice`; - [ ] **Blocked by [#496](https://github.com/cubenoy22/Loka/issues/496)** — the Win32 board settles to an incompletely-painted grid on ~1 run in 3 and the two-frame settle rule accepts it, so a golden would encode a coin-flip ([characterization](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-496-repro.txt)); macOS bakes both MineSweeper cells at 0 differing pixels | Scenario: `new-game-twice`; - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh minesweeper new-game-twice`; audit byte match, 0 differing pixels) | Scenario: `new-game-twice`; - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh minesweeper new-game-twice`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `ScrapbookUI` | n/a — no Linux GUI application target | Scenario: `flip-forward-back`; - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-scrapbook-flip-forward-back-verify.log) (`tests/win32/run-scenario.ps1 scrapbook flip-forward-back`, rig `omen`) | Scenario: `flip-forward-back`; - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh scrapbook flip-forward-back`; audit byte match, 0 differing pixels) | Scenario: `flip-forward-back`; - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh scrapbook flip-forward-back`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
| `SimpleViewer` | n/a — no Linux GUI application target | - [ ] Runner absent — `SimpleViewer` registers no scenario in `tests/scenarios/scenarios.txt`; the intent-level open-document door it needs is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) | - [ ] Runner absent — `SimpleViewer` registers no scenario in `tests/scenarios/scenarios.txt`; the intent-level open-document door it needs is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) | - [ ] Runner absent — `SimpleViewer` registers no scenario in `tests/scenarios/scenarios.txt`; the intent-level open-document door it needs is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) |
| `Tutorial` | n/a — no Linux GUI application target | Scenario: `increment-summary-toggle`; - [x] ✅ [Win32 golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/win32-x64-2026-08-27) + [verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/win32-omen-cell-tutorial-increment-summary-toggle-verify.log) (`tests/win32/run-scenario.ps1 tutorial increment-summary-toggle`, rig `omen`) | Scenario: `increment-summary-toggle`; - [x] ✅ [macOS golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/macos-tahoe-2026-08-27) + [bake/verify log](https://raw.githubusercontent.com/cubenoy22/Loka/pr-assets/v0.0.4-rc-59e32626/macos-tahoe-bake-verify.log) (`LOKA_MACOS_RIG=tahoe tests/macos/run-scenario.sh tutorial increment-summary-toggle`; audit byte match, 0 differing pixels) | Scenario: `increment-summary-toggle`; - [x] ✅ [Classic golden bundle](https://github.com/cubenoy22/Loka/tree/pr-assets/golden/classic-maciix-2026-08-26) (`tests/toolbox/run-scenario.sh tutorial increment-summary-toggle`; baked and verified at `a36148fa`, carried to the RC by the no-op proof in the release PR) |
...
| L1 Classic `SimpleViewer` | Runner absent — no registered scenario; the intent-level open-document door is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) |
| L2 Classic `SimpleViewer` | Runner absent — no registered scenario; the intent-level open-document door is tracked by [#375](https://github.com/cubenoy22/Loka/issues/375) |
