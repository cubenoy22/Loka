...
| Page            | State/DerivedState/Tracker を内包し、UI ロジックを一元化。              |
...
- **Page** … State, MutableState, DerivedState, Tracker すべてを内包
...
| UI 再構築 | build(PageBuilder&)    | body, Composable 等      |
| 所有権    | Page が全 State を所有 | View/Component 等        |
