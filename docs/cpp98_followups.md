...
1. **tests/SceneTests.hpp** still uses lambdas, `auto`, and `override`. Down-port or exclude it from legacy builds so the Win32 sample suite also compiles under C++98.
