  ...
  namespace app
  {
    namespace scene
    {
      ...
      public:
        ...
        IStateOwner *stateOwner() const
        {
          return stateOwner_;
        }
        void setStateOwner(IStateOwner *owner)
        {
          stateOwner_ = owner;
        }
        ...
        void setBoundary(BoundaryNode *boundary)
        {
          boundary_ = boundary;
        }
        IPlatformController *platformController() const
        {
          return platformController_;
        }
        void setPlatformController(IPlatformController *controller)
        {
          platformController_ = controller;
        }
        Scene *scene() const
        {
          return scene_;
        ...
        void setComposition(NodeComposition *comp)
        {
          composition_ = comp;
        }
        ...
        void setDirtyFlags(NodeDirtyFlags flags)
        {
          dirtyFlags_ = flags;
        }
