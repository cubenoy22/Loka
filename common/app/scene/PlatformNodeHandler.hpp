#ifndef LOKA_CORE2_SCENE_PLATFORM_NODE_HANDLER_HPP
#define LOKA_CORE2_SCENE_PLATFORM_NODE_HANDLER_HPP
    ...
    namespace scene
    {
      ...
      public:
        ...
        virtual NodeContext *ensureContext(Node *node,
                                           ...
                                           const LayoutState &state) = 0;
      };

      class PlatformNodeHandlerRegistry
      {
      public:
        PlatformNodeHandlerRegistry() : head_(0) {}
...
#endif // LOKA_CORE2_SCENE_PLATFORM_NODE_HANDLER_HPP
