...
namespace loka
{
  namespace app
  {
    ...
    struct MsgBoxProps
    {
      loka::core::State<loka::core::String> *title;
      loka::core::State<loka::core::String> *body;
      loka::core::MutableState<bool> *show;
      loka::core::MutableState<int> *result; // optional
      MsgBoxIcon::Value icon;
      MsgBoxProps()
          : title(0), body(0), show(0), result(0), icon(MsgBoxIcon::Error)
      {
      }
      MsgBoxProps &setTitle(loka::core::State<loka::core::String> *t)
      {
        title = t;
        return *this;
      }
