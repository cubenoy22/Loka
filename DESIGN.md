...
| How do request delivery / queue / seat / settle work? | [docs/RequestDeliveryDesign.md](docs/RequestDeliveryDesign.md) | [`RequestSettlement.hpp`](common/app/scene/state/RequestSettlement.hpp) and rail request tests |
