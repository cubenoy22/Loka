...
| How do request delivery / settle work? | [docs/RequestDeliveryDesign.md](docs/RequestDeliveryDesign.md) | [`RequestSettlement.hpp`](common/app/scene/state/RequestSettlement.hpp) and rail request tests |
