#ifndef LOKA_TESTS_SCENARIOS_TUTORIAL_SCENARIO_PRESENTATION_HPP
#define LOKA_TESTS_SCENARIOS_TUTORIAL_SCENARIO_PRESENTATION_HPP
    ...
    private:
      void composeObservedWindow(AppComposition &composition, const app::scene::NodeDefinitionBase &mainDefinition)
      {
        composition << WindowDef(this->productionWindowProps(mainDefinition)
                                     ...
                                     .onIdle(&TutorialScenarioPresentation::OnWindowIdle, this));
      }

      static void OnWindowIdle(Window *window, double elapsedSeconds, void *userData)
      {
        TutorialScenarioPresentation *self = static_cast<TutorialScenarioPresentation *>(userData);
        if (self)
        {
...
#endif // LOKA_TESTS_SCENARIOS_TUTORIAL_SCENARIO_PRESENTATION_HPP
